...
## Batch 44: AI Governance

### Skill 1: Human-in-the-loop Workflows

```
Create a comprehensive SKILL.md for Human-in-the-loop (HITL) workflows in AI systems.

Location: 59-ai-governance/human-approval-flows/SKILL.md
...
3. HITL workflow patterns:
   - Pre-approval: Human approves before AI acts
   - Post-approval: AI acts, human can override
   - Hybrid: AI suggests, human decides
   - Escalation: AI handles routine, escalate exceptions
4. Confidence thresholds:
   - High confidence (>95%): Auto-approve
   - Medium confidence (80-95%): Human review
   - Low confidence (<80%): Require approval
5. Implementing HITL:
...
6. Review queue management:
   - Prioritization (high-impact first)
   - Load balancing across reviewers
   - SLA tracking
7. Reviewer interfaces:
   - Context display (why AI made this decision)
...
10. Tools and platforms:
    - Labelbox (for annotations)
    - Scale AI (for review workflows)
    - Custom workflow systems (Temporal, Airflow)
11. Reducing HITL burden over time:
    - Improving model confidence
    - Identifying auto-approvable patterns
12. Real-world HITL examples:
    - Content moderation
    - Loan approvals
    - Medical diagnosis assistance
13. Implementation examples (TypeScript, Python)

Format: Include workflow diagrams, approval interface mockups, and code examples.

Create the file now.
```

### Skill 2: Confidence Scoring

```
Create a comprehensive SKILL.md for AI Confidence Scoring and Calibration.

Location: 59-ai-governance/confidence-scoring/SKILL.md

Cover:
1. What is confidence scoring
2. Types of confidence:
   - Model confidence (softmax probabilities)
   - Calibrated confidence (aligned with accuracy)
   - Ensemble confidence (multiple models agree)
3. Why confidence matters:
   - Knowing when to trust AI
   - Deciding when to escalate to humans
   - Setting thresholds for actions
...
6. Confidence thresholds:
   - Setting thresholds based on business needs
   - Precision-recall trade-offs
   - Cost-benefit analysis
7. Confidence in different model types:
   - Classification models
   - Regression models
   - LLMs (perplexity, logits)
   - Ensemble models
8. Multi-model confidence:
   - Averaging probabilities
   - Voting mechanisms
   - Confidence agreement
9. Confidence in production:
   - Logging confidence scores
   - Monitoring confidence distribution
   - Alerting on low confidence
10. Using confidence for:
    - Auto-approval thresholds
    - Human review triggers
    - A/B test bucketing
11. LLM-specific confidence:
    - Token probabilities
    - Self-evaluation prompts
    - "I don't know" detection
12. Confidence UI/UX:
    - Displaying uncertainty to users
    - "Low confidence" warnings
13. Real examples:
    - Medical diagnosis (high confidence required)
    - Content recommendations (lower confidence ok)
14. Implementation (Python, TypeScript)

Format: Include calibration code, threshold selection guides, and visualization examples.

Create the file now.
```

### Skill 3: Override Mechanisms

```
Create a comprehensive SKILL.md for AI Override Mechanisms.

Location: 59-ai-governance/override-mechanisms/SKILL.md
...
3. When to allow overrides:
   - AI makes obvious mistakes
   - User has special knowledge
   - Business rules require it
   - Compliance reasons
4. Override workflow:
   - Display AI decision + confidence
   - Allow human to override
   - Require justification
   - Log override
   - Optional: second approval for critical overrides
5. Override tracking:
   - Override rate (% of decisions)
   - Override reasons
   - Override outcomes (was override correct?)
6. Learning from overrides:
   - Feedback to model training
   - Identifying systematic errors
   - Improving confidence calibration
7. Override permissions:
   - Role-based (who can override)
   - Decision-type based
   - Approval workflows for high-stakes overrides
8. Override UI patterns:
   - Edit in place
   - Alternative suggestions
   - Free-text correction
   - Predefined override reasons
9. Preventing override abuse:
   - Audit logs
   - Manager reviews
   - Statistical anomaly detection
10. Emergency kill switches:
    - Feature flags to disable AI
    - Rollback to rule-based system
    - Manual mode
11. Override in different contexts:
    - Content moderation
    - Fraud detection
    - Recommendation systems
    - Automated trading
12. Tools: Workflow systems, audit logging, feature flags
13. Real examples of override scenarios
14. Implementation (TypeScript, Python)

Format: Include override workflow diagrams, UI mockups, and audit logging code.

Create the file now.
```

### Skill 4: AI Auditability

```
Create a comprehensive SKILL.md for AI Auditability and Logging.

Location: 59-ai-governance/auditability/SKILL.md
...
2. What to log:
   - Input data (anonymized if sensitive)
   - Model predictions
   - Confidence scores
   - Model version
   - Timestamp
...
3. Audit log structure:
   ...
   - Input features
   - Output prediction
   - Metadata (confidence, latency, etc.)
4. Audit log storage:
   - Immutable logs
   - Long-term retention
   - Efficient querying
   - Compliance with data retention policies
5. Tools for audit logging:
   - MLflow
   - Weights & Biases
...
6. Querying audit logs:
   ...
   - Find all low-confidence predictions
   - Find all overrides
...
11. Audit log access control
12. Real-world audit scenarios:
    - "Why did the model reject this loan?"
    - "Show me all AI decisions for user X"
13. Implementation examples (Python, TypeScript)

Format: Include audit log schemas, query examples, and compliance checklists.

Create the file now.
```

### Skill 5: Explainability

```
Create a comprehensive SKILL.md for AI Explainability (XAI).

Location: 59-ai-governance/explainability/SKILL.md

Cover:
1. What is explainability and why it matters:
   - Building trust
   - Regulatory requirements
   - Debugging models
   - Detecting bias
2. Types of explanations:
   - Global explanations (how model works overall)
...
5. LIME (Local Interpretable Model-agnostic Explanations):
   - How LIME works
   - LIME for tabular, text, image data
   - Implementation with lime library
6. LLM explainability:
   - Attention weights
   - Prompting for reasoning ("think step-by-step")
   - Chain-of-thought explanations
   - Self-explanation prompts
7. Presenting explanations to users:
   - Feature contribution bars
   - Natural language explanations
   - Visual explanations (heatmaps)
   - Confidence + explanation
8. Explainability for different audiences:
   - End users (simple, non-technical)
   - Data scientists (detailed, technical)
   - Regulators (compliance-focused)
9. Trade-offs:
   - Accuracy vs explainability
   - Complexity vs interpretability
10. Tools: SHAP, LIME, InterpretML, Captum, Alibi
11. Explainability in production:
    - Pre-computing explanations
    - On-demand explanations
    - Caching strategies
12. Real-world explainability examples:
    - Credit scoring
    - Medical diagnosis
    - Fraud detection
13. Regulatory requirements (GDPR, AI Act)
14. Implementation examples (Python)

Format: Include SHAP/LIME code examples, visualization examples, and UI mockups.

Create the file now.
```

### Skill 6: AI Risk Assessment

```
Create a comprehensive SKILL.md for AI Risk Assessment.

Location: 59-ai-governance/ai-risk-assessment/SKILL.md
...
1. Types of AI risks:
   ...
   - Reliability risks (model failures)
   - Ethical risks (harmful content)
   - Reputational risks
...
10. High-risk AI systems (EU AI Act):
...
13. Tools: Fairlearn, AI Fairness 360, Adversarial Robustness Toolbox
14. Real AI risk case studies
...
7. **59-ai-governance** (HITL, confidence, safety) - AI production readiness

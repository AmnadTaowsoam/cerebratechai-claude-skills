# Vector Database Patterns (Pinecone, Qdrant, Weaviate)

## 1. Vector Database Concepts

### What are Vector Databases?
Vector databases are specialized databases designed to store, index, and query high-dimensional vectors efficiently. They enable similarity search by finding vectors that are "closest" to a query vector using various distance metrics.
